...
execute positioned as @r in wyhaworld:lagmorphia run item replace entity @e[tag=boss,limit=1,sort=random,distance=5..] weapon.offhand with tipped_arrow{Potion:"strong_slowness"}

execute positioned as @r in wyhaworld:lagmorphia run item replace entity @e[tag=boss,limit=1,sort=random,distance=..4] weapon.offhand with tipped_arrow{Potion:"strong_harming"}

execute positioned as @e[tag=boss] in wyhaworld:lagmorphia run effect give @e[distance=..8,limit=1,sort=random,type=#skeletons] instant_damage
